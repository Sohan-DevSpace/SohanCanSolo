    ...
    >
      ...
      >
        ...
        <div className="text-center lg:text-left mb-8 relative z-10">
          ...
          <p className="text-white/80 text-[13px] font-medium leading-relaxed max-w-[320px] mx-auto lg:mx-0">Enter your email and password to manage your account and track orders.</p>
        </div>
